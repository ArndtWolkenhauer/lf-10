...
def process_user_input(user_text: str):
    ...
    # Lehrerantwort + ggf. nächste Prüfungsfrage
    if len(st.session_state["fragen_gestellt"]) < 7:
        ...
        st.session_state["answer_times"].append((time.time(), 0))  # Zeitpunkt neue Frage
